...
an_local_data_folder_prod <- here::here("..", "mobile-app", "data", "prod", "ap")
...
an_local_data_folder_dev <- here::here("..", "mobile-app", "data", "dev", "an")
...
an_local_data_folder <- here::here("..", "mobile-app", "data", an_status, "an")
...
an_base_dir <- '//sky.corp.eurocontrol.int/DFSRoot/Groups/HQ/dgof-pru/Data/DataProcessing/Covid19/ToRunDaily/test/'
an_base_file <- '099d_app_ansp_dataset.xlsx'
