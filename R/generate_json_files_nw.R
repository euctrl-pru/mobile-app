...
nw_delay_for_json <- nw_delay_data %>%
  ...
  mutate(
    ...
    RWEEK_DLY_ERT_FLT = AVG_ERT_ROLLING_WEEK / nw_traffic_last_day$TOTAL_ROLLING_WEEK,
...
#airport delay
  mutate(
    ...
    RWEEK_DLY_APT_FLT = AVG_APT_ROLLING_WEEK / nw_traffic_last_day$TOTAL_ROLLING_WEEK,
