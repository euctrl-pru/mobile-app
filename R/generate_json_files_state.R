...
write(st_json_app, here(archive_dir_raw_backup, "st", "st_json_app.json"))
...
write(st_ao_data_j, here(archive_dir_raw_backup, "st", "st_ao_ranking_traffic.json"))

### Airports ----
#### day ----
mydataframe <- "st_apt_data_day_raw"
myarchivefile <- paste0(data_day_text, "_", mydataframe, ".csv")
stakeholder <- str_sub(mydataframe, 1, 2)
...
write(st_apt_data_j, here(archive_dir_raw_backup, "st", "st_apt_ranking_traffic.json"))
...
write(st_st_data_j, here(archive_dir_raw_backup, "st","st_ctry_ranking_traffic_DAI.json"))
...
write(st_acc_delay_j, here(archive_dir_raw_backup, "st","st_acc_ranking_delay.json"))
...
write(st_apt_delay_j, here(archive_dir_raw_backup, "st","st_apt_ranking_delay.json"))
...
write(st_apt_punctuality_j, here(archive_dir_raw_backup, "st", "st_apt_ranking_punctuality.json"))
...
write(st_daio_evo_app_j, here(archive_dir_raw_backup, "st" ,"st_daio_evo_chart_daily.json"))
...
write(st_dai_evo_app_j, here(archive_dir_raw_backup, "st", "st_dai_evo_chart_daily.json"))
...
write(st_ovf_evo_app_j, here(archive_dir_raw_backup, "st", "st_ovf_evo_chart_daily.json"))
...
write(st_punct_evo_app_j, here(archive_dir_raw_backup, "st" ,"st_punct_evo_chart.json"))
...
write(st_delay_cause_evo_dy_j, here(archive_dir_raw_backup, "st" ,"st_delay_category_evo_chart_dy.json"))
...
write(st_delay_cause_evo_wk_j, here(archive_dir_raw_backup, "st" ,"st_delay_category_evo_chart_wk.json"))
...
write(st_delay_cause_evo_y2d_j, here(archive_dir_raw_backup, "st", "st_delay_category_evo_chart_y2d.json"))
...
write(st_delay_type_evo_dy_j, here(archive_dir_raw_backup, "st", "st_delay_flt_type_evo_chart_dy.json"))
...
write(st_delay_type_evo_wk_j, here(archive_dir_raw_backup, "st", "st_delay_flt_type_evo_chart_wk.json"))
...
write(st_delay_type_evo_y2d_j, here(archive_dir_raw_backup, "st", "st_delay_flt_type_evo_chart_y2d.json"))
...
write(st_billing_evo_j, here(archive_dir_raw_backup, "st", "st_billing_evo.json"))
...
write(st_co2_evo_j, here(archive_dir_raw_backup, "st", "st_co2_evo.json"))
