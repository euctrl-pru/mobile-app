...
query <- "WITH
  ...
  AP_LIST AS (
  SELECT
              distinct ICAO_CODE as icao_code
...
apt_punct_for_json <- apt_punct_for_json %>%
...
save_json(apt_json_app, "apt_json_app")
