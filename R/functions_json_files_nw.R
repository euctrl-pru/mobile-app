...
## delay ----
nw_delay_category_evo_charts <- function(data_day_date){
...
nw_delay_flt_type_evo_charts <- function(data_day_date){
...
nw_ao_ranking_traffic <- function(data_day_date){
  ### day ----
...
## Airport traffic ----
nw_apt_ranking_traffic <- function(data_day_date){
  ### day ----
...
## Country traffic DAI ----
nw_ctry_ranking_traffic_DAI <- function(data_day_date){
  ### day----
...
## Airport delay -----
nw_apt_ranking_delay <- function(data_day_date){
  ### raw data
...
## ACC delay ----
nw_acc_ranking_delay <- function(data_day_date){
  ### day ----
...
## Country delay ----
nw_ctry_ranking_delay <- function(data_day_date){
  ### day ----
...
nw_apt_ranking_punctuality <- function(data_day_date){
...
### we need data from 2019 so I'm using the source view instead of the excel file
nw_ctry_ranking_punctuality <- function(data_day_date){
